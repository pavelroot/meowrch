...
BASE = Packages(
	pacman=DistributionPackages(
		common=[
            ...
            "noto-fonts-cjk", "noto-fonts-emoji", "noto-fonts-extra", "flameshot", "rofi-wayland", "mpv", "piper"
		],
	...
	aur=DistributionPackages(
		common=[
			...
			"youtube-dl", "update-grub", "ttf-meslo-nerd-font-powerlevel10k", "visual-studio-code-bin", "qogir-gtk-theme", "rog-control-center", "mpvpaper"
		],
